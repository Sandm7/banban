...
export default {
   ...
   methods:{
       movieList(){
           this.$jsonp('https://m.douban.com/rexxar/api/v2/subject_collection/movie_free_stream/items',{os:"ios",for_mobile:1,callback:"jsonp1",start:num,count:18,loc_id:"108288",_:"1513302961321"}).then(data =>{
               //console.log(data)
