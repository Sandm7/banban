<template>
  <div class="movieList">
      <div class="wrapper" ref="wrapper">
         <div>
             <h3 class="movieListHeader">{{text}}</h3>
             <ul class="grid">
...
export default {
   ...
   methods:{
       movieList(){
           ...
           this.$jsonp('https://m.douban.com/rexxar/api/v2/subject_collection/'+this.id+'/items',{os:"ios",for_mobile:1,callback:"jsonp1",start:num1,count:18,loc_id:"108288",_:"1513302961321"}).then(data =>{
               //console.log(data)
