...
export default {
   ...
   methods:{
       bookList(){
           this.$jsonp('https://m.douban.com/rexxar/api/v2/subject_collection/book_nonfiction/items',{os:"ios",for_mobile:1,callback:"jsonp1",start:num,count:18,loc_id:"108288",_:"1513312950647"}).then(data =>{
               //console.log(data)
